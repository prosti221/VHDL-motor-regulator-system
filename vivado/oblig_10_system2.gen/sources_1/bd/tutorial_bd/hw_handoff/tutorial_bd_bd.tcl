...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set DIR_sync_0 [ create_bd_port -dir O DIR_sync_0 ]
  set EN_sync_0 [ create_bd_port -dir O EN_sync_0 ]
  set SA_0 [ create_bd_port -dir I SA_0 ]
  set SB_0 [ create_bd_port -dir I SB_0 ]
  set abcdefg_0 [ create_bd_port -dir O -from 6 -to 0 abcdefg_0 ]
  set c_0 [ create_bd_port -dir O c_0 ]
  set mclk_0 [ create_bd_port -dir I mclk_0 ]
  ...
  # Create instance: system_struct_0, and set properties
  set system_struct_0 [ create_bd_cell -type ip -vlnv carlosan.org:carlosan:system_struct:1.0 system_struct_0 ]
  ...
  connect_bd_net -net SA_0_1 [get_bd_ports SA_0] [get_bd_pins system_struct_0/SA]
  connect_bd_net -net SB_0_1 [get_bd_ports SB_0] [get_bd_pins system_struct_0/SB]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins system_struct_0/duty_cycle]
  connect_bd_net -net mclk_0_1 [get_bd_ports mclk_0] [get_bd_pins system_struct_0/mclk]
  ...
  connect_bd_net -net reset_0_1 [get_bd_ports reset_0] [get_bd_pins system_struct_0/reset]
  ...
  connect_bd_net -net system_struct_0_DIR_sync [get_bd_ports DIR_sync_0] [get_bd_pins system_struct_0/DIR_sync]
  connect_bd_net -net system_struct_0_EN_sync [get_bd_ports EN_sync_0] [get_bd_pins system_struct_0/EN_sync]
  connect_bd_net -net system_struct_0_abcdefg [get_bd_ports abcdefg_0] [get_bd_pins system_struct_0/abcdefg]
  connect_bd_net -net system_struct_0_c [get_bd_ports c_0] [get_bd_pins system_struct_0/c]
  connect_bd_net -net system_struct_0_velocity [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins system_struct_0/velocity]
